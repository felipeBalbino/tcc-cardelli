...
public class EnviarEmail {
	...
	public void sendMailToAluno(DisciplinaLetiva dl, String fileName,
		...
		for (Aluno aluno : dl.getAluno()) {
			...
			emailContent = emailContent
					+ "NÃ£o responda este email, ele foi gerado automaticamente.";
			emailContent = emailContent + "<br>";
	...
	public void sendArquivoPeloAluno(Arquivo arquivo, String fileName,
		...
		emailContent = emailContent + "<br>";
		emailContent = emailContent
				+ "Nï¿½o responda este email, ele foi gerado automaticamente.";
		emailContent = emailContent + "<br>";
		emailContent = emailContent + "Att. Equipe CQI";
	...
	public void sendExceptionToAdministrador(Exception rex, Pessoa p)
		...
		msgBody = msgBody + "<b>Exception Message : </b>" + rex.getMessage()
				+ "<br><br>";
		msgBody = msgBody
				+ "<hr style='border-bottom:1px;border-style:dotted;border-color:#CCCCCC'><center><h3>Dados do Usuï¿½rio</h3></center><hr style='border-bottom:1px;border-style:dotted;border-color:#CCCCCC'><table><tr><td>";
		...
		msgBody = msgBody + "<br></br>";
		msgBody = msgBody
				+ "Intranet FGS <br></br> Desenvolvido pelo Centro de Qualidade da Informaï¿½ï¿½o.";
